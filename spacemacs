...
you should place your code here."
  ...
  ;; activate centered cursor plugin
  (and
   (require 'centered-cursor-mode)
   (global-centered-cursor-mode +1))

  ;; set font size to reasonable
